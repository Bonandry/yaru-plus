...
# echo "Replace light colour (for dark environments) for dark colour (forr light environments):"

# sed -E --in-place --follow-symlinks 's/(#666|#353945|#4d4d4d|#fff|#f2f2f7)/#808080/g' *.svg

echo "Following the standard colours for dark mode, recommended by Apple, with the finality to respect the accessibility"

echo "Blue"
sed -E --in-place --follow-symlinks 's/(#0072f9|#1a7fd4|#1d99f3|#5294e2|#02a8f3|#049ef5|#007eff)/#0084ff/g' *.svg
echo "Green"
sed -E --in-place --follow-symlinks 's/(#76c22b|#70c932|#53992c|#46a926|#1ea362|#7ad42b|#61a83d)/#30d158/g' *.svg
echo "Orange"
sed -E --in-place --follow-symlinks 's/(#fb7c38|#dd4814|#ff6d00)/#ff9f0a/g' *.svg
echo "Pink"
